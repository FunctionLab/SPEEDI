...
#' @export
run_SPEEDI <- function(tissue, data_path = getwd(), reference_dir = getwd(), sample_id_list = NULL, human = TRUE, record_doublets = FALSE) {
  ...
  reference <- LoadReferenceSPEEDI(tissue, human, reference_dir)
